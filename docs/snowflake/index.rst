...
Sparkflows jobs can read from and write to Snowflake.
...
Sparkflows also incorporates pushdown into Snowflake. The various nodes of the workflow push down processing into Snowflake. Hence, it is entirely possible that the whole processing happens in Snowflake.


Snowflake Spark Connector
---------------

Sparkflows uses the Snowflake Spark connector for reading from and writing to Snowflake.
