Writing Jupyter Notebook for Apps
=========================

The Analytics App in Sparkflows empowers users to initiate the execution of a Notebook in Jupyter. The output generated by the Notebook is seamlessly displayed within the Analytical Apps interface. 
...
The Jupyter Notebook can output tables, charts, html etc. to be displayed in the Analytical Apps. To leverage the Sparkflows API for data transmission, you need to add the wheel file to your Jupyter Notebook. 
...
The integration between Sparkflows and Jupyter enhances collaboration and improves data analysis capabilities.
