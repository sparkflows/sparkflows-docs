...
Sparkflows Provides option to user to select the data, type, evaluation metrics, target column, model type and build the automl model from H2O and pycaret.
...
Sparkflows enable you to schedule job on databricks cluster.
...
Sparkflows enable you to use new processors added for data quality great expectations as below:
...
Sparkflows enable you to show Data Quality informations with Great-expectations.
