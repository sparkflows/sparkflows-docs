Version 3.1.28 -  June, 2022
========

These features and Sparkflows platform improvements were released in June 2022.

AutoML Upgrades
--------

Sparkflows enables you to add Favourite auto-ml Execution Experiment from number of executions run with different parameters.
...
Sparkflows now have support for airflow with 2.x, it comes with different operators, once dag submitted from UI can be verify from Airflow.
...
Sparkflows enable to update User roles and Permission changes, Sharing of project to group, Changes in project-overview dashboard as per needed permission.
