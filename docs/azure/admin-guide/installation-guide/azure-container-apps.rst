...
This document describes the steps for installing Sparkflows on Azure Container Apps.
...
Sparkflows stores the metadata in a relational store. 

.. note:: MySQL needs to be set up before installing Sparkflows.
