Version 3.1.30 - August, 2022
========

These features and Sparkflows platform improvements were released in August 2022.

NEW CONNECTIONS
----------

Now Sparkflows enable you to create Different Compute Connection and submit the job on respective connection.
...
Sparkflows Now enable you to Integrate Airflow running on Remote server, create Dags in S3 and Sync up to remote machine using cron job.
...
Sparkflows enable you add comments for project you are using.
