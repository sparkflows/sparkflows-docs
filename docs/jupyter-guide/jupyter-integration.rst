...
#. Input the required general attributes:
   ...
   * Description (Optonal) - About connection.
     ...
     .. figure:: ..//_assets/jupyter/add-jupyter-connection-1.rst
...
#. Input the kubernetes configuration details:
   ...
   * Another available image - **sparkflows/fire:jupyternotebook.5**
     ...
     .. figure:: ..//_assets/jupyter/add-connection-kubernetes.rst
        :alt: jupyter-notebook
        :width: 60%
...
#. Select Jupyter Notebook connection from drop down.
   ...
   .. figure:: ..//_assets/jupyter/analytics-app-jupyter-run.rst
      :alt: jupyter-notebook
      :width: 60%

#. Next, add one stage which must have an Execute button with action - execute. Click on **Run**. 

   For more details on how to create analytical apps, read `Sparkflows Documentaion on Anlaytical Apps.<https://docs.sparkflows.io/en/latest/user-guide/web-app/index.html>`_
