...
1. Calculating ``totalprice = price * lotsize`` after the row filter
2. Then select the final columns: **id**, **price**, **lotsize**, **bedrooms**, and **totalprice**.
...
Add a Save CSV node as a new branch after node 6 to save to "/path/to/file/output" with overwrite mode
...
Add a node between node 4 and 6 to print the first 3 rows

**Remove/Delete - Example Prompts**
+++++++++++++++++++++
