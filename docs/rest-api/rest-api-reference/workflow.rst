...
The Workflow REST APIs, allow you to create, update, and delete workflows.

Below are the various Workflow APIs available in Sparkflows. They should be executed after you have logged into Sparkflows.
