...
Sparkflows has a processor that allows you to connect with Cassandra. Apache Cassandra is a distributed NoSQL database designed for handling large amounts of data. 

Before creating a workflow using the Read and Save Cassandra nodes, you must first set up a connection to the Cassandra database in Sparkflows. To learn how to create this connection, click on  :ref:`Create Cassandra Connection<Cassandra Connection>`.
