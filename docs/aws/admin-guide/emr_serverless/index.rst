Amazon EMR Serverless Integration
======


Sparkflows integrates with Amazon EMR Serverless to enable the user to create Amazon EMR Serverless connection and submit the jobs on it.
