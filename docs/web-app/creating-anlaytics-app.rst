...
.. figure:: ../_assets/tutorials/web-app/list.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/create.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-upload-column.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-upload-file.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-upload-textfield.PNG
   :alt: web-app
   :width: 60%

- And add upload button and perform actions depending upon event, where we will add event name as upload.

.. figure:: ../_assets/tutorials/web-app/add-stage-upload-button1.PNG
   :alt: web-app
   :width: 60%

.. figure:: ../_assets/tutorials/web-app/add-stage-upload-button2.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-next-button1.PNG
   :alt: web-app
   :width: 60%

.. figure:: ../_assets/tutorials/web-app/add-stage-next-button2.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-parameters-selectboxes.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-parameters-select.PNG
  :alt: web-app
  :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-parameters-back.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-parameters-next.PNG
   :alt: web-app
   :width: 60%

.. figure:: ../_assets/tutorials/web-app/add-stage-parameters-buttons.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-run-title.PNG
   :alt: web-app
   :width: 60%
...
.. figure:: ../_assets/tutorials/web-app/add-stage-run-runbtn.PNG
   :alt: web-app
   :width: 60%

.. figure:: ../_assets/tutorials/web-app/add-stage-run-buttons.PNG
   :alt: web-app
   :width: 60%
