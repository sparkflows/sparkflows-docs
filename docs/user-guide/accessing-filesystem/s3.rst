...
Sparkflows enables you to use AWS S3 when it is configured.

By default, Sparkflows includes sample data bundled in its binary with a data folder in the home directory.

You can copy the data folder to a specified location in S3 and configure the path to be used in Sparkflows.
...
#. Click on **Save Configurations** button to save and update the path.
