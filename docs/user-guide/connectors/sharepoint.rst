...
.. note:: Only files accessible to the configured SharePoint credentials are retrieved. The SharePoint Data Extraction node performs read-only operations and does not modify SharePoint data. This node does not require an input DataFrame.
