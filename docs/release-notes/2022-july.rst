Version 3.1.29 -  July, 2022
========

These features and Sparkflows platform improvements were released in July 2022.
...
Sparkflows enables you to provide Dashboard with Persona access on the basis of their requirements ie. Admin, Analyst or Business-User.

Inorder to Enable Dashboard Persona, Administrator of Sparkflows enable its module from configurations.
...
Sparkflows Administrator can provide required persona access depending on its usability, while creating user or an existing user.

.. figure:: ..//_assets/releases/july-2022/persona_useradd.PNG
   :alt: persona
   :width: 70%

Once the Persona got added user can login to Sparkflows and on User Drop down, you will see Switch Persona and on selection of respective persona user will have access to it.
...
Sparkflows enable you create report with both Classic and standard method.
...
Sparkflows enable you to configure IAM Assume role for accessing s3 bucket.
...
The arn of the assume role should be added in Group Configurations of Sparkflows application.
...
Sparkflows eanble you to support Databricks Runtime version 10.4
